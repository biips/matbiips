...
%   - seed:         int. RNG seed used for data generation if 'sample_data' is 
%                   true. Randomly generated by default.
%
%   OUTPUT:
...
optarg_names = {'sample_data', 'quiet', 'seed'};
optarg_default = {true, false, get_seed()};
optarg_valid = {{true, false}, {true, false}, [0 intmax]};
optarg_type = {'logical', 'logical', 'numeric'};
[sample_data, quiet, seed] = parsevar(varargin, optarg_names, optarg_type,...
...
%% compile model
matbiips('compile_model', id, data, sample_data, seed, false);
